...
[\033[1;31m3\033[1;36m] EDITAR CLIENTE GENERICO \033[1;30m(mudar config do cliente gerado)\033[1;36m
[\033[1;31m4\033[1;36m] RECARREGAR SERVIÇOS OVPN\033[1;30m(reiniciar serviços)\033[1;36m
...
exit;;
	...
	clear
	echo -e "\033[1;36m Bem vindo ao instalador OpenVPN\033[0m"
	echo ""
	# OpenVPN instalador e criação do primeiro usuario
	echo ""
	echo -e "\033[01;32m Responda as perguntas para iniciar a instalação"
	echo -e "\033[01;32m Responda corretamente"
	echo ""
	sleep 1
	echo -e "\033[01;36m ENTER para confirmar\033[0m"
  tput setaf 3 ; tput bold ; read -p "IP: "  -e -i $IP IP
  echo ""
	echo -e "\033[01;36m QUAL PROTOCOLO DESEJA USAR PARA AS CONEÇOES OPENVPN ?\033[0m"
	echo -e "\033[1;36m|\033[1;31m1\033[1;36m| UDP"
	echo -e "\033[1;36m|\033[1;31m2\033[1;36m| TCP \033[1;31m(Recomendado)\033[01;37m"
	...
	echo -e "$linha"
	echo ""
	echo -e "\033[01;36m QUAL A PORTA DESEJA USAR\033[01;37m ?"
	read -p " PORTA: " -e -i 443 PORT
	echo ""
  echo -e "\033[01;36m QUAL DNS DESEJA USAR ?"
  	echo ""
	echo -e "\033[1;36m|\033[1;31m1\033[1;36m| Sistema"
	echo -e "\033[1;36m|\033[1;31m2\033[1;36m| Google"
	echo -e "\033[1;36m|\033[1;31m3\033[1;36m| OpenDNS"
	echo -e "\033[1;36m|\033[1;31m4\033[1;36m| Cloudflare"
	echo -e "\033[1;36m|\033[1;31m5\033[1;36m| Level 3"
	echo -e "\033[1;36m|\033[1;31m6\033[1;36m| Verisign"
	read -p " DNS [1-6]: " -e -i 2 DNS
	echo ""
	echo -e "\033[01;36m DIGITE O NOME DO SEU ARQUIVO PADRÃO"
	read -p " NOME: " -e -i client CLIENT
	echo ""
	echo -e "\033[01;32m Okay, você está pronto para executar o openvpn.\033[01;37m"
...
sed -i '3i\127.0.0.1 portalrecarga.vivo.com.br/controle\' /etc/hosts
sed -i '4i\127.0.0.1 navegue.vivo.com.br/pre\' /etc/hosts
sed -i '4i\127.0.0.1 navegue.vivo.com.br/controle\' /etc/hosts
sed -i '5i\127.0.0.1 d1n212ccp6ldpw.cloudfront.net\' /etc/hosts
service squid restart 1> /dev/null 2> /dev/null
service squid3 restart 1> /dev/null 2> /dev/null
echo ""
echo -e "\033[1;32mOPENVPN INSTALADO COM SUCESSO!"
echo ""
echo -e "\033[01;31m•\033[01;37mSEU ARQUIVO ESTA DISPONIVEL NA PASTA ROOT DO SEU SERVIDOR"	
sleep 3s
ovpn
exit
fi
